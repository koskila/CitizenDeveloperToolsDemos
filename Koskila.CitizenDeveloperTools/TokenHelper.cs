...
namespace Koskila.CitizenDeveloperTools
{
    public static class TokenHelper
    {
        ...
        public static AzureEnvironment getAzureEnvironment(string tenantUrl)
        {
            AzureEnvironment env = AzureEnvironment.Production;
            if (tenantUrl.EndsWith(".de"))
                env = AzureEnvironment.Germany;
    ...
    public class MultipleSymmetricKeySecurityToken : SecurityToken
    {
        ...
        private static List<SecurityKey> CreateSymmetricSecurityKeys(IEnumerable<byte[]> keys)
        {
